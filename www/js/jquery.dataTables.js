...
(/** @lends <global> */function($, window, document, undefined) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  sSearchStr.replace('_INPUT_', '<input autocorrect="off" autocomplete="off" type="text" />') :
			  sSearchStr==="" ? '<input autocorrect="off" autocomplete="off" type="text" />' : sSearchStr+' <input autocorrect="off" autocomplete="off" type="text" />';
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "Displaying Patients _START_ to _END_ (_TOTAL_ Total)",
